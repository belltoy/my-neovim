local function on_attach(bufnr)
  ...
  vim.keymap.set('n', '<C-[>', api.node.show_info_popup,              opts('Info'))
  ...
  vim.keymap.set('n', 't', api.node.open.tab, opts('Tabnew'))
  vim.keymap.set('n', 'p', api.node.navigate.parent, opts('Parent node'))
  vim.keymap.set('n', 'P', api.fs.paste, opts('Paste'))
  vim.keymap.set('n', 'C', api.tree.change_root_to_node, opts('Cd'))
  -- vim.keymap.set('n', 'O', api.node.run.system, opts('System open'))
  vim.keymap.set('n', 'D', api.tree.toggle_hidden_filter, opts('Toggle dotfiles'))
  -- vim.keymap.set('n', 'I',     api.tree.toggle_gitignore_filter,      opts('Toggle Filter: Git Ignore'))
